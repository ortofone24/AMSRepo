    ...
    public partial class DB_A47B47_ortofoneContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=sql6010.site4now.net;Initial Catalog=DB_A47B47_ortofone;Persist Security Info=True;User ID=DB_A47B47_ortofone_admin;Password=Hanusia321Mama");
            }
        }
